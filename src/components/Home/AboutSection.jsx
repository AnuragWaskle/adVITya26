    ...
    return (
        <div className="w-full h-full min-h-150 sm:min-h-screen relative flex justify-center items-center z-30">
            <div className="container mx-auto max-w-4xl px-4 text-white/60 text-center">
                ...
                >
                    Dive into the heart of VIT Bhopal with AdVlTya'26 - an electrifying blend of technology and culture. Crafted by the ingenious minds of VIT Bhopal students, AdVlTya'26 transcends the ordinary, presenting a dynamic showcase of innovation and creativity. Join us for an immersive experience where every moment sparks brilliance, turning the campus into a canvas of unbridled talent and celebration. AdVlTya'26 is more than an event; it's a journey where the extraordinary takes center stage, inviting you to witness and be part of the magic!
                </motion.p>
